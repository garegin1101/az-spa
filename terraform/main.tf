...
resource "azurerm_windows_function_app" "products_service" {
  name     = "fa-products-service-ne-001aaaaaa"
  location = "northeurope"
  ...
  site_config {
    ...
    cors {
      allowed_origins = ["https://portal.azure.com", "https://gareginfrontend001.z16.web.core.windows.net"]
    }
...
resource "azurerm_windows_function_app" "import_service" {
  name     = "fa-import-service-ne-001aaaaaa"
  location = "northeurope"
